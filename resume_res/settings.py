"""
Django settings for resume_res project.
...
SECRET_KEY = "django-insecure-iaq^x+=_un!kg58+dx4l7fcpopy^!kz3kr-_++xcs_u8z(k!*v"
...
WSGI_APPLICATION = "resume_res.wsgi.application"
